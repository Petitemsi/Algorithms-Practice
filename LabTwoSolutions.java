...
public class LabTwoSolutions
{
	...
	// 					if(!(letter_1==possible_letters.length-1 && letter_2==possible_letters.length-1 && letter_3==possible_letters.length-1 && letter_4==possible_letters.length-1)) {
	// 						strB.append(",");
	// 					}
		...
		for(int letter_1=0; letter_1<possible_letters.length; letter_1++)
		{
			for(int letter_2=0; letter_2<possible_letters.length; letter_2++)
			{
				for(int letter_3=0; letter_3<possible_letters.length; letter_3++)
				{
					...
					strB.append(possible_letters[letter_1]+""+possible_letters[letter_2]+""+possible_letters[letter_3] );

					if(!(letter_1==possible_letters.length-1 && letter_2==possible_letters.length-1 && letter_3==possible_letters.length-1)) {
						strB.append(",");
					}
